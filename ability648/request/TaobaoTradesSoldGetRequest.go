...
func (s *TaobaoTradesSoldGetRequest) SetBuyerOpenId(v string) *TaobaoTradesSoldGetRequest {
    s.BuyerOpenId = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetFields(v []string) *TaobaoTradesSoldGetRequest {
    s.Fields = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetStartCreated(v util.LocalTime) *TaobaoTradesSoldGetRequest {
    s.StartCreated = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetEndCreated(v util.LocalTime) *TaobaoTradesSoldGetRequest {
    s.EndCreated = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetStatus(v string) *TaobaoTradesSoldGetRequest {
    s.Status = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetBuyerNick(v string) *TaobaoTradesSoldGetRequest {
    s.BuyerNick = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetType(v string) *TaobaoTradesSoldGetRequest {
    s.Type = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetExtType(v string) *TaobaoTradesSoldGetRequest {
    s.ExtType = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetRateStatus(v string) *TaobaoTradesSoldGetRequest {
    s.RateStatus = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetTag(v string) *TaobaoTradesSoldGetRequest {
    s.Tag = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetPageNo(v int64) *TaobaoTradesSoldGetRequest {
    s.PageNo = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetPageSize(v int64) *TaobaoTradesSoldGetRequest {
    s.PageSize = &v
    return s
}
func (s *TaobaoTradesSoldGetRequest) SetUseHasNext(v bool) *TaobaoTradesSoldGetRequest {
    s.UseHasNext = &v
    return s
}

func (req *TaobaoTradesSoldGetRequest) ToMap() map[string]interface{} {
...
func (req *TaobaoTradesSoldGetRequest) ToFileMap() map[string]interface{} {
